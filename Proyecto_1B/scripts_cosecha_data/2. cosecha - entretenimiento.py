...
try:
    ...
    db = server.create('entretenimiento_1')
except:
    #Caso contrario solo conectarse a la base existente
    db = server['entretenimiento_1']
    
#Aqui se define el bounding box con los limites geograficos donde recolectar los tweets
twitterStream.filter(track=["popmusic","sports","christmasmusic","reggae","reggaeton","rock","concierts","games","videogames"])
